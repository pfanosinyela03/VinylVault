...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView regredirect;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView2,
      ...
      @NonNull ImageButton loginimageButton, @NonNull TextView regredirect,
    ...
    this.loginimageButton = loginimageButton;
    this.regredirect = regredirect;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.loginimageButton;
      ImageButton loginimageButton = ViewBindings.findChildViewById(rootView, id);
      if (loginimageButton == null) {
        break missingId;
      }

      id = R.id.regredirect;
      TextView regredirect = ViewBindings.findChildViewById(rootView, id);
      if (regredirect == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, imageView2, loginButton,
          loginPassword, loginUsername, loginimageButton, regredirect, textView2);
    }
